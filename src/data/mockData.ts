...
export const muscleGroups: MuscleGroup[] = [
  ...
  { id: 'quads', name: 'Quads', sizeCategory: 'major' },
  { id: 'hamstrings', name: 'Hamstrings', sizeCategory: 'major' },
  { id: 'glutes', name: 'Glutes', sizeCategory: 'major' },
  { id: 'biceps', name: 'Biceps', sizeCategory: 'minor' },
  { id: 'triceps', name: 'Triceps', sizeCategory: 'minor' },
  { id: 'calves', name: 'Calves', sizeCategory: 'minor' },
  { id: 'abs-core', name: 'Abs/Core', sizeCategory: 'minor' },
  { id: 'forearms', name: 'Forearms', sizeCategory: 'minor' },
]
...
export const exerciseCatalog: ExerciseDefinition[] = [
  ...
  },
  {
    ...
    secondaryMuscleGroupIds: ['glutes', 'back', 'forearms'],
  },
  {
    id: 'squat',
    ownerUserId: null,
  ...
  },
  {
    ...
    source: 'system',
    primaryMuscleGroupId: 'hamstrings',
    secondaryMuscleGroupIds: ['glutes', 'back'],
  },
  {
    id: 'calf-raise',
    ownerUserId: null,
  ...
  },
  {
    ...
    source: 'system',
    primaryMuscleGroupId: 'shoulders',
    secondaryMuscleGroupIds: ['abs-core', 'forearms'],
  },
]
